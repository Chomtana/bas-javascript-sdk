...
export declare type Web3Uint256 = string;
...
export declare type TValidatorStatus = 'NOT_FOUND' | 'ACTIVE' | 'PENDING' | 'JAILED' | 'UNKNOWN';
export declare const VALIDATOR_STATUS_MAPPING: Record<any, TValidatorStatus>;
...
export declare enum TGovernanceProposalStatus {
    Pending = 0,
    Active = 1,
    Cancelled = 2,
    Defeated = 3,
...
export declare type TGovernanceVoteType = 'AGAINST' | 'FOR' | 'ABSTAIN';
...
export declare type IEventData = EventData;
