...
var STAKING_ABI = require('./abi/Staking.json');
var SLASHING_INDICATOR_ABI = require('./abi/SlashingIndicator.json');
var SYSTEM_REWARD_ABI = require('./abi/SystemReward.json');
var STAKING_POOL_ABI = require('./abi/StakingPool.json');
var GOVERNANCE_ABI = require('./abi/Governance.json');
var CHAIN_CONFIG_ABI = require('./abi/ChainConfig.json');
var RUNTIME_UPGRADE_ABI = require('./abi/RuntimeUpgrade.json');
var DEPLOYER_PROXY_ABI = require('./abi/DeployerProxy.json');
var RELAY_HUB_ABI = require('./abi/RelayHub.json');
var CROSS_CHAIN_BRIDGE_ABI = require('./abi/CrossChainBridge.json');
var KDI_MASTERCHEF_ABI = require('./abi/KDIMasterChef.json');
var KDI_TOKEN_ABI = require('./abi/KDIToken.json');
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        this.kdiTokenContract = new web3.eth.Contract(KDI_TOKEN_ABI, this.config.kdiTokenAddress);
                        this.kdiMasterChefContract = new web3.eth.Contract(KDI_MASTERCHEF_ABI, this.config.kdiMasterChefAddress);
                        return [2 /*return*/];
                }
            });
        });
